...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"is_active"=>nil, "is_deleted"=>nil, "name"=>nil, "course_id"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_type"=>nil, "exam_id"=>nil, "observable_id"=>nil, "student_id"=>nil, "batch_id"=>nil}
